...
urlpatterns = [
    ...
    path('collection/<slug:collection_uuid>/', CollectionListView.as_view(), name='detail-collection'),
    path('collection/detail/<slug:collection_uuid>/', CollectionListDetailView.as_view(), name='detail-collection'),
